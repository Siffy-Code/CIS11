...
.equ PINGT, 24		
.equ PINRW, 27
.equ PINYW, 28		//NOT USED IN THIS VERSION - ONLY RED/GREEN WALK LIGHTS
.equ PINGW, 29
...
signal:					//WALK SIGNAL PROGRAM WITH BLINK LOOP
	...
	mov r0, #PINRW		//INITIALIZE RED WALK LIGHT
	mov r1, #HIGH		
	bl digitalWrite
...
end_signal:				//NOT SAFE TO CROSS
	...
	mov r1, #LOW
	bl digitalWrite
	mov r0, #PINRW		//FINISH BLINK RED BEFORE SET ON
	mov r1, #LOW
	bl digitalWrite
	mov r0, #PINRW
	mov r1, #HIGH
